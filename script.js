...
/* harmony import */ var _src_js_modules_sliders_sliderMain__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! /src/js/modules/sliders/sliderMain */ "./src/js/modules/sliders/sliderMain.js");
...
window.addEventListener('DOMContentLoaded', () => {
  const mainSliderPageOne = new _src_js_modules_sliders_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    next: '.next'
  }).render();
  const mainSliderPageTwo = new _src_js_modules_sliders_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    next: '.next',
    prev: '.prev'
  }).render();
  const showUpSliderPageOne = new _modules_sliders_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  const moduleSliderPageOne = new _modules_sliders_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  const feedSliderPageOne = new _modules_sliders_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.feed__slider',
    prev: '.feed .slick-prev',
    next: '.feed .slick-next',
    activeClass: '.feed__item-active'
  }).init();
  const mainPageOne = new _src_js_modules_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]({
    trigger: '.showup__video .play',
    popup: '.overlay'
  }).init();
  const mainPageTwo = new _src_js_modules_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]({
    trigger: '.module__video-item .play',
    popup: '.overlay'
  }).init();
  const differenceOld = new _src_js_modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]({
    column: '.officerold',
    items: '.officer__card-item',
    trigger: '.plus'
  }).init();
  const differenceNew = new _src_js_modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]({
    column: '.officernew',
    items: '.officer__card-item',
    trigger: '.plus'
  }).init();
  const formJoin = new _src_js_modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]({
    form: '.join__evolution form',
    path: 'assets/question.php'
  }).init();
  const formSchedule = new _src_js_modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]({
...
/* harmony import */ var _src_js_modules_sliders_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! /src/js/modules/sliders/slider */ "./src/js/modules/sliders/slider.js");


class SliderMain extends _src_js_modules_sliders_slider__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slider */ "./src/js/modules/sliders/slider.js");



class SliderMini extends _slider__WEBPACK_IMPORTED_MODULE_2__["default"] {
...
class VideoPlayer {
  ...
  closePopup() {
    this.popup.addEventListener('click', e => {
      ...
      if (target && target == this.popup || target && target.matches('.close')) {
